...
@section('content')
    ...
    {{-- Active Elections --}}
    <div onclick="openModal('activeModal')" class="cursor-pointer flex-1 min-w-[200px] p-6 rounded-2xl shadow-xl border border-gray-100
                   bg-gradient-to-r from-blue-500 to-indigo-500 text-white transform hover:scale-105
    ...
    {{-- Closed Elections --}}
    <div onclick="openModal('closedModal')" class="cursor-pointer flex-1 min-w-[200px] p-6 rounded-2xl shadow-xl border border-gray-100
    ...
    {{-- Upcoming Elections --}}
    <div onclick="openModal('upcomingModal')" class="cursor-pointer flex-1 min-w-[200px] p-6 rounded-2xl shadow-xl border border-gray-100
                   bg-gradient-to-r from-green-400 to-teal-500 text-white transform hover:scale-105
                   transition duration-300">
        <div class="flex flex-col">
    ...
    {{-- Total Voters --}}
    <div onclick="openModal('votersModal')" class="cursor-pointer flex-1 min-w-[200px] p-6 rounded-2xl shadow-xl border border-gray-100
